...
export default function CertificateDetailPage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#0B0F0C] flex flex-col justify-center items-center p-4">
        ...
        <div className="border border-gray-700 rounded-lg p-6 mb-8">
          ...
          <h1 className="text-2xl font-bold text-lime-400 mb-4">
            ...
            {certificate.certificateDataFromDB
              ? certificate.certificateDataFromDB?.certificateTheme
              : "qw"}
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <Typography>
                {certificate.certificateDataFromDB?.recipientIIN}
              </Typography>
            </div>
            ...
            {certificate.certificateDataFromDB?.issuerType ===
              ...
              <div>
                ...
                <Typography>
                  {certificate.certificateDataFromDB?.organisationName}
                </Typography>
          ...
          <div className="mt-6">
            ...
            <div className="bg-gray-900 p-4 rounded">
              <Typography className="whitespace-pre-line">
                {certificate.certificateDataFromDB?.certificateBody}
              </Typography>
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-700 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Typography className="font-mono break-all">
                ...
                certificate.verification.certificateHash ===
                  certificate.verification.smartContractCertificateHash
                  ? "Valid"
                  : "Invalid"}
              </Typography>
            </div>
            ...
            <div>
              ...
              <Typography className="font-mono break-all">{id}</Typography>
            </div>
  ...
  return (
    <div className="min-h-screen bg-[#0B0F0C] flex justify-center items-center">
      <div className="text-center space-y-4">
        ...
        <Typography className="text-lime-400">{message}</Typography>
      </div>
    </div>
  );
}
