...
export default function CreateCertificatePage() {
    ...
    return (
        <main className="min-h-screen px-4 py-8 mt-44 flex flex-col items-center gap-24 relative">
            <Image src={createCertBg} alt="bg" className="absolute right-[300px] top-[-240px]"/>
            {/* Main Heading */}
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div>
                            ...
                            <InputField
                                ...
                                onChange={(e) =>
                                    setCertificateBody(e.target.value)
                                }
                                type="text"
                            />
                        </div>
